				...
				<section className='py-16 px-4 md:px-6'>
					<div className='container mx-auto max-w-6xl'>
						<div className='text-center mb-12'>
							<h2 className='text-3xl font-bold mb-4 text-jdblue'>
							...
							{services.map((service, index) => (
								<Card
									...
									<div className='relative h-48'>
										...
										/>
										<div className='absolute inset-0 bg-linear-to-t from-black/70 to-transparent opacity-70'></div>
										...
										<ul className='space-y-1 mb-4'>
											{service.items.map((item, i) => (
												<li
													...
													<svg
														className='h-5 w-5 text-jdred mr-2 shrink-0'
														fill='none'
														viewBox='0 0 24 24'
														stroke='currentColor'>
														<path
									...
									<CardFooter className='px-6 pb-6 pt-0'>
										<Link
											href={service.url}
											className='group inline-flex items-center text-jdred font-medium'>
											Saiba mais
				...
				<section className='py-16 px-4 md:px-6 bg-gray-50'>
					<div className='container mx-auto max-w-6xl'>
						<div className='grid md:grid-cols-2 gap-12 items-center'>
							<div>
								<h2 className='text-3xl font-bold mb-6 text-jdblue'>
									Nosso Processo de Atendimento
								</h2>
								<p className='text-gray-600 mb-6'>
									Na JDINFO, seguimos um processo estruturado para garantir a
									melhor experiência e resultado para nossos clientes:
								</p>

								<div className='space-y-6'>
									<div className='flex items-start'>
										<div className='w-10 h-10 rounded-full bg-jdred text-white flex items-center justify-center mr-4 shrink-0'>
											1
										</div>
										<div>
											...
											<p className='text-gray-600'>
												Realizamos uma análise completa do seu equipamento para
												identificar com precisão o problema, sem compromisso e
												sem custos.
											</p>
										</div>
									</div>
									...
									<div className='flex items-start'>
										...
										<div>
											...
											<p className='text-gray-600'>
												Apresentamos um orçamento claro e detalhado, explicando
												o problema, a solução proposta e os custos envolvidos.
											</p>
										</div>
									</div>
									...
									<div className='flex items-start'>
										...
										<div>
											...
											<p className='text-gray-600'>
												Realizamos testes completos para garantir que o
												equipamento esteja funcionando perfeitamente.
											</p>
										</div>
									</div>
									...
									<div className='flex items-start'>
										...
										<div>
											...
											<p className='text-gray-600'>
												Devolvemos seu equipamento funcionando perfeitamente e
												com garantia de 90 dias em todos os serviços.
											</p>
										</div>
									</div>
								</div>
							...
							<div className='bg-jdblue/80 p-6 rounded-lg'>
								...
								<ul className='space-y-3'>
									<li className='flex items-start'>
										...
										<span>Mais de 20 anos de experiência em Niterói</span>
									</li>
									<li className='flex items-start'>
										<svg
											className='h-5 w-5 text-jdred mr-2 mt-0.5'
